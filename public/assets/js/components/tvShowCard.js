...
TVshowCard = function (data) {
    ...
    this.getCard = function () {
        return `<div class="column is-4 animated fadeIn">
                <div class="card">
                    <div class="card-image">
                        <div class=" is-16by9">
                            <div class="banner" data-showid="${data.id}" style='cursor:pointer; height:75px; background-image: url(${this.banner}); background-position: center; background-size: cover;
                            ' alt="Image"></div>
                        </div>
                    </div>
